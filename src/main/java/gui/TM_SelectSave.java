 ...
 * @author Nancy
 */
public class TM_SelectSave extends javax.swing.JFrame {
    private TMDrillModel tmDM;
    private static String vennUrl = "src/visual/d3-venndiagram/";
    ...
    private void saveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveBtnActionPerformed
        ...
        if(visualCB.isSelected()){
            filesToSave.add(vennUrl+"venn-"+tmDM.getTablename()+".html");
            filesToSave.add(vennUrl+"d3.js");
